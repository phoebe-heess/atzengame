...
var JSAnimation = class extends WithPromise {
  ...
  initAnimation() {
    ...
    if (define_process_env_default.NODE_ENV !== "production" && generatorFactory !== keyframes) {
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left" }) => {
  ...
  if (define_process_env_default.NODE_ENV !== "production" && mode === "wait" && renderedChildren.length > 1) {
...
function useStrictMode(configAndProps, preloadedFeatures) {
  ...
  if (define_process_env_default.NODE_ENV !== "production" && preloadedFeatures && isStrict) {
