import {
  require_react_dom
} from "./chunk-J2KVZ76M.js";
import {
  require_react
} from "./chunk-EICOZEFE.js";
import {
  __toESM,
...
function useHref(to, _temp) {
  ...
  !useInRouterContext() ? define_process_env_default.NODE_ENV !== "production" ? invariant(
    false,
...
function useNavigateUnstable() {
  ...
  let navigate = React.useCallback(function(to, options) {
    ...
    define_process_env_default.NODE_ENV !== "production" ? warning(activeRef.current, navigateEffectWarning) : void 0;
...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
  ...
  if (locationArg) {
    ...
    !(parentPathnameBase === "/" || ((_parsedLocationArg$pa = parsedLocationArg.pathname) == null ? void 0 : _parsedLocationArg$pa.startsWith(parentPathnameBase))) ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, "When overriding the location using `<Routes location>` or `useRoutes(routes, location)`, the location pathname must begin with the portion of the URL pathname that was " + ('matched by all parent routes. The current pathname base is "' + parentPathnameBase + '" ') + ('but pathname "' + parsedLocationArg.pathname + '" was given in the `location` prop.')) : invariant(false) : void 0;
  ...
  if (define_process_env_default.NODE_ENV !== "production") {
    define_process_env_default.NODE_ENV !== "production" ? warning(parentRoute || matches != null, 'No routes matched location "' + location.pathname + location.search + location.hash + '" ') : void 0;
    define_process_env_default.NODE_ENV !== "production" ? warning(matches == null || matches[matches.length - 1].route.element !== void 0 || matches[matches.length - 1].route.Component !== void 0 || matches[matches.length - 1].route.lazy !== void 0, 'Matched leaf route at location "' + location.pathname + location.search + location.hash + '" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.') : void 0;
  }
...
function _renderMatches(matches, parentMatches, dataRouterState, future) {
  ...
  if (errors != null) {
    ...
    !(errorIndex >= 0) ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, "Could not find a matching route for errors on route IDs: " + Object.keys(errors).join(",")) : invariant(false) : void 0;
...
function useDataRouterContext(hookName) {
  ...
  !ctx ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, getDataRouterConsoleError(hookName)) : invariant(false) : void 0;
  return ctx;
}
function useDataRouterState(hookName) {
  let state = React.useContext(DataRouterStateContext);
  !state ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, getDataRouterConsoleError(hookName)) : invariant(false) : void 0;
  return state;
}
function useRouteContext(hookName) {
  let route = React.useContext(RouteContext);
  !route ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, getDataRouterConsoleError(hookName)) : invariant(false) : void 0;
  return route;
}
function useCurrentRouteId(hookName) {
  let route = useRouteContext(hookName);
  let thisRoute = route.matches[route.matches.length - 1];
  !thisRoute.route.id ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, hookName + ' can only be used on routes that contain a unique "id"') : invariant(false) : void 0;
...
function warningOnce(key, cond, message) {
  if (!cond && !alreadyWarned$1[key]) {
    ...
    define_process_env_default.NODE_ENV !== "production" ? warning(false, message) : void 0;
  }
}
var alreadyWarned = {};
function warnOnce(key, message) {
  if (define_process_env_default.NODE_ENV !== "production" && !alreadyWarned[message]) {
...
function Navigate(_ref4) {
  ...
  define_process_env_default.NODE_ENV !== "production" ? warning(!isStatic, "<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.") : void 0;
  let {
    matches
  } = React.useContext(RouteContext);
  let {
...
function Route(_props) {
  define_process_env_default.NODE_ENV !== "production" ? invariant(false, "A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.") : invariant(false);
}
function Router(_ref5) {
  ...
  !!useInRouterContext() ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, "You cannot render a <Router> inside another <Router>. You should never have more than one in your app.") : invariant(false) : void 0;
  ...
  define_process_env_default.NODE_ENV !== "production" ? warning(locationContext != null, '<Router basename="' + basename + '"> is not able to match the URL ' + ('"' + pathname + search + hash + '" because it does not start with the ') + "basename, so the <Router> won't render anything.") : void 0;
...
function createRoutesFromChildren(children, parentPath) {
  ...
  React.Children.forEach(children, (element, index) => {
    ...
    !(element.type === Route) ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, "[" + (typeof element.type === "string" ? element.type : element.type.name) + "] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>") : invariant(false) : void 0;
    !(!element.props.index || !element.props.children) ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, "An index route cannot have child routes.") : invariant(false) : void 0;
    let route = {
...
function mapRouteProperties(route) {
  ...
  if (route.Component) {
    if (define_process_env_default.NODE_ENV !== "production") {
      if (route.element) {
        define_process_env_default.NODE_ENV !== "production" ? warning(false, "You should not include both `Component` and `element` on your route - `Component` will be used.") : void 0;
      }
    }
  ...
  if (route.HydrateFallback) {
    if (define_process_env_default.NODE_ENV !== "production") {
      if (route.hydrateFallbackElement) {
        define_process_env_default.NODE_ENV !== "production" ? warning(false, "You should not include both `HydrateFallback` and `hydrateFallbackElement` on your route - `HydrateFallback` will be used.") : void 0;
      }
    }
    Object.assign(updates, {
  ...
  if (route.ErrorBoundary) {
    if (define_process_env_default.NODE_ENV !== "production") {
      if (route.errorElement) {
        define_process_env_default.NODE_ENV !== "production" ? warning(false, "You should not include both `ErrorBoundary` and `errorElement` on your route - `ErrorBoundary` will be used.") : void 0;
      }
    }
    Object.assign(updates, {
...
function getFormEncType(encType) {
  if (encType != null && !supportedFormEncTypes.has(encType)) {
    define_process_env_default.NODE_ENV !== "production" ? warning(false, '"' + encType + '" is not a valid `encType` for `<Form>`/`<fetcher.Form>` ' + ('and will default to "' + defaultEncType + '"')) : void 0;
    return null;
  }
  return encType;
}
...
function RouterProvider(_ref) {
  ...
  React2.useEffect(() => {
    define_process_env_default.NODE_ENV !== "production" ? warning(fallbackElement == null || !router.future.v7_partialHydration, "`<RouterProvider fallbackElement>` is deprecated when using `v7_partialHydration`, use a `HydrateFallback` component instead") : void 0;
  }, []);
  ...
  if (typeof to === "string" && ABSOLUTE_URL_REGEX2.test(to)) {
    ...
    if (isBrowser) {
      try {
        ...
        define_process_env_default.NODE_ENV !== "production" ? warning(false, '<Link to="' + to + '"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.') : void 0;
      }
    }
  }
  let href = useHref(to, {
...
function useDataRouterContext2(hookName) {
  ...
  !ctx ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, getDataRouterConsoleError2(hookName)) : invariant(false) : void 0;
  return ctx;
}
function useDataRouterState2(hookName) {
  let state = React2.useContext(DataRouterStateContext);
  !state ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, getDataRouterConsoleError2(hookName)) : invariant(false) : void 0;
  return state;
}
...
function useSearchParams(defaultInit) {
  define_process_env_default.NODE_ENV !== "production" ? warning(typeof URLSearchParams !== "undefined", "You cannot use the `useSearchParams` hook in a browser that does not support the URLSearchParams API. If you need to support Internet Explorer 11, we recommend you load a polyfill such as https://github.com/ungap/url-search-params.") : void 0;
...
function useFormAction(action, _temp2) {
  ...
  !routeContext ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, "useFormAction must be used inside a RouteContext") : invariant(false) : void 0;
...
function useFetcher(_temp3) {
  ...
  !fetcherData ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, "useFetcher must be used inside a FetchersContext") : invariant(false) : void 0;
  !route ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, "useFetcher must be used inside a RouteContext") : invariant(false) : void 0;
  !(routeId != null) ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, 'useFetcher can only be used on routes that contain a unique "id"') : invariant(false) : void 0;
  ...
  let load = React2.useCallback((href, opts) => {
    !routeId ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, "No routeId available for fetcher.load()") : invariant(false) : void 0;
...
function useScrollRestoration(_temp4) {
  ...
  usePageHide(React2.useCallback(() => {
    ...
    try {
      ...
      define_process_env_default.NODE_ENV !== "production" ? warning(false, "Failed to save scroll positions in sessionStorage, <ScrollRestoration /> will not work properly (" + error + ").") : void 0;
    }
    window.history.scrollRestoration = "auto";
...
function useViewTransitionState(to, opts) {
  ...
  !(vtContext != null) ? define_process_env_default.NODE_ENV !== "production" ? invariant(false, "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?") : invariant(false) : void 0;
  let {
    basename
