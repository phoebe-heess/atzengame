...
function App() {
  ...
  const handleAgeCheckConfirm = (allowed: boolean) => {
    if (allowed) {
      ...
      // Track session start and time of day usage
      analyticsService.trackSessionStart();
      analyticsService.trackTimeOfDayUsage();
      analyticsService.trackLocationUsage();
    }
  };
  ...
  const handleBoosterActivated = () => {
    if (currentBooster) {
      ...
      // Track usage event for trends
      analyticsService.trackUsageEvent('booster_activated');
  ...
  const handleBoosterWon = (booster: Booster) => {
    ...
    // Track usage event for trends
    analyticsService.trackUsageEvent('booster_won');
  };
